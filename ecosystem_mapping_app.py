...
# Define the path for saving the HTML file, accommodating different environments
try:
    # Path for server environments like Streamlit Sharing
    path = "/tmp"
    file_path = f"{path}/network_graph.html"
...
st.markdown(
    ...
    The network graph is built on [pyvis](https://pyvis.readthedocs.io/en/latest/index.html) and displayed using [streamlit](https://streamlit.io/). Included are 7 I&E entities and their relationships among different programs. 
    
    This demo intends to serve as a tool to evaluate further data collection, development, and implementation for students, faculty, entrepreneurs, healthcare providers and researchers. The overall aim is to provide a clear and accessible overview of the I&E ecosystem, and a tool to efficiently navigate through it.
    """
)
...
st.markdown(
    """    
    ### UNC I&E Ecosystem Entities

    #### Innovate Carolina
    - **Tech Type**: General
    - **Description**: Connects innovators and entrepreneurs to a network of resources, supporting ideas, initiatives, and ventures. It plays a key role in supporting fellows and faculty.
    - **Key Resources**: Impact Measurement and Reporting, Data Management, and Economic and Social Impact Tracking.
    - **Affiliations**: Office of Technology Commercialization, KickStart Venture Services.
    - [Website](https://innovate.unc.edu/)

    #### FastTraCS
    - **Tech Type**: Medtech
    - **Description**: Aims to identify opportunities for creating MedTech solutions, targeting healthcare practitioners, researchers, and administrators.
    - **Key Resources**: Needs Discovery Programs, Design Services.
    - **Affiliations**: NC TraCS Institute, School of Medicine.
    - [Website](https://tracs.unc.edu/index.php/services/fasttracs)

    #### The Eshelman Institute
    - **Tech Type**: Therapeutics, Digital Health
    - **Description**: Funds translational research in areas like oncology, infectious disease, and neuroscience. Open to ideas in devices, diagnostics, and other therapeutic areas.
    - **Key Resources**: Funding and Grants, Mentorship and Support.
    - **Affiliation**: Eshelman School of Pharmacy.
    - [Website](https://unceii.org/)

    #### Venture Catalyst Program
    - **Tech Type**: General
    - **Description**: Provides business support to startups and entrepreneurial fellows, facilitating the translation of ideas into the market.
    - **Key Resources**: Funding and Grants, Mentorship Programs.
    - **Affiliations**: KickStart Venture Services, Innovate Carolina.
    - [Website](https://innovate.unc.edu/venture-catalyst-program/)

    #### Center for the Business of Health
    - **Tech Type**: General
    - **Description**: Brings together expertise to discuss healthcare's business aspects, offering programs and activities focusing on the intersection of business and health.
    - **Key Resources**: Educational Events like the Business of Healthcare Conference.
    - **Affiliation**: Kenan-Flagler Business School.
    - [Website](https://cboh.unc.edu/)

    #### KickStart Venture Services
    - **Tech Type**: General
    - **Description**: Supports research-based startups with education, funding, and accelerator space, and connects founders to the innovation ecosystem.
    - **Key Resources**: Funding and Grants, Mentorship Programs, Accelerator Spaces.
    - **Affiliations**: Office of Technology Commercialization, Innovate Carolina.
    - [Website](https://innovate.unc.edu/startup-accelerators-and-venture-services/kickstart-venture-services/)

    #### Office of Technology Commercialization
    - **Tech Type**: General
    - **Description**: Accelerates the translation of ideas into products and services, supporting inventors, startups, and industry partners.
    - **Key Resources**: Patent and Market Research.
    - **Affiliations**: Innovate Carolina, KickStart Venture Services.
    - [Website](https://innovate.unc.edu/)
         
    ### Relationships
    
    The demo models the following relationships:
    
    - "Feeds Into" – It implies a progression or development from one program to another.
    - "Flows from" – This highlights the source or foundational aspect of one program leading to another.
    - "Umbrella Program" – It conveys the idea of a broader, encompassing program that oversees or encompasses smaller initiatives.
    - "Sub-Program" – This term suggests a smaller, more focused initiative under the larger program.
    - "Partners With" – This could imply a more formal or structured relationship between programs.
    
    ### Resources
    
    The data underlying the model also includes the following resource model:
    
    **Educational Resources:**
    - Workshops: Various workshops aimed at skill development, including Design Thinking workshops.
    ...
    - Events: Conferences and networking sessions for learning, networking, and collaboration, like annual innovation symposiums or entrepreneur meetups.
    ...
    **Technology and Infrastructure:**
    ...
    - Accelerator Spaces: Spaces designed to accelerate the growth of startups.
...
st.markdown(
    """
    <br>
    <h6><a href="https://github.com/akantuncch/IE-Mapping" target="_blank">GitHub Repo</a>
    """,
